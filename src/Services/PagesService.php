...
class PagesService extends AbstractController{
    ...
    private $news_services;
    private $request;

    function __construct(ManagerRegistry $doctrine, PostsService $posts_services, NewsletterService $news_services){
    ...
    public function getMainPage() {
        $page = $this->getPageStatus(true);
        return $page;
    }

    public function getPage(string $page_id){
        $page = $this->getPageStatus(false, $page_id);
        return $page;
    }

    public function getPageStatus(bool $main_page, string $page_id = null)
    {
        if($main_page){
        ...
        $newsForm = $this->news_services->getNewsForm();
